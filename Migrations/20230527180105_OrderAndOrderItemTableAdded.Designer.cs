...
namespace PustokProject.Migrations
{
    ...
    [Migration("20230527180105_OrderAndOrderItemTableAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P328Pustok.Models.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokProject.Models.BookComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokProject.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokProject.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokProject.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("P328Pustok.Models.BasketItem", b =>
                {
                    b.HasOne("PustokProject.Models.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PustokProject.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("PustokProject.Models.Order", "Order")
                        .WithMany("OrderItems")
